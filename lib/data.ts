...
function getFallbackMatches(): Match[] {
  const matches = [
    ...
    { home: "Morocco", away: "Haiti", homeScore: 3, awayScore: 2, state: "live", label: "مباشر", utcDate: "2026-06-24T22:00:00Z", _index: 15 },
    { home: "Scotland", away: "Brazil", homeScore: 0, awayScore: 3, state: "live", label: "مباشر", utcDate: "2026-06-24T22:00:00Z", _index: 16 },
